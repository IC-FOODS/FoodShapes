...
In order to reach a broader audience, we include some example data. To maintain consistency with the schema, the data can be tested for conformance with the schema.
